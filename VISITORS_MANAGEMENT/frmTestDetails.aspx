<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmTestDetails.aspx.cs" Inherits="frmTestDetails" %>
             ...
             <tr>
                 ...
                 <table cellpadding="2" cellspacing="0" border="0" width="100%">
                     <tr>
                         ...
                         <td>&nbsp;<asp:CheckBox ID="chkTestOneEye" runat="server" AutoPostBack="True" Font-Size="20px" OnCheckedChanged="chkTestOneEye_CheckedChanged" Text="فحص العين" />
                         </td>
                         <td>
                     ...
                     <tr>
                         <td>
                             <asp:Label ID="Label23" runat="server" CssClass="lblBox" Font-Bold="True" Font-Size="20px" Text="النتائج : "></asp:Label>
                         </td>
                         <td colspan="6">
